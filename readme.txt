...
WP Media Folder will be synchronized with Lightroom. This magic requires also the WP/LR Sync plugin to be installed.
...
2. Install WP Media Folder
3. Install WP Media Folder for WP/LR Sync (this plugin)
